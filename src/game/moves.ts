...
export const createJojMoves = (d: JojMovesDeps) => ({
  ...
  playLegendaryCard: (args: MoveArgs, cardId: string, targetPlayerID?: string, selectedResource?: ResourceKey) => {
    ...
    if (card.id === 'legendary-02') {
      ...
      specialMessage = canceled.canceledCard
      ...
      d.syncPlayerState(args.G, playerID);
      specialMessage = d.legendaryTexts.statueTor(playerLabel, d.resourceLabelsUk[selectedResource]);
      ...
      d.clampNonNegativeResources(args.G.resources[playerID]);
      d.syncPlayerState(args.G, playerID);
      specialMessage = d.legendaryTexts.churchLeadership(playerLabel);
      ...
      d.syncPlayerState(args.G, playerID);
      specialMessage = d.legendaryTexts.waterRestore(playerLabel, d.resourceLabelsUk[selectedResource], before, after);
      ...
      specialMessage = granted.applied
      ...
      specialMessage = d.legendaryTexts.droidDemote(d.getPlayerLabel(args.G, targetPlayerID), d.rankNameById(demoted.fromRankId), d.rankNameById(demoted.toRankId));
    }
