...
export const rulesListUk = [
  ...
  'Карта ВВНЗ вимагає сплатити 2 будь-які ресурси, одразу дає бонус нового звання і змушує пропустити наступний хід.',
...
export const rulesListEn = [
  ...
  'A VVNZ card costs any 2 resources, immediately grants the new rank bonus, and makes you skip your next turn.',
...
export const rulesPageUk: RulesPageContent = {
  ...
  cardTypes: [
    ...
    { title: 'ВВНЗ', description: 'Працює на того, хто її зіграв: треба сплатити 2 будь-які ресурси, отримати звання і його бонус, а потім пропустити наступний хід.' },
  ...
  promotionPoints: [
    ...
    'Карта ВВНЗ не використовує звичайні вимоги і вартість переходу: замість цього вона коштує 2 будь-які ресурси, одразу дає бонус звання і змушує пропустити наступний хід.',
...
export const rulesPageEn: RulesPageContent = {
  ...
  cardTypes: [
    ...
    { title: 'VVNZ', description: 'Applies to the source player: pay any 2 resources, gain the rank and its bonus, then skip your next turn.' },
  ...
  promotionPoints: [
    ...
    'A VVNZ card ignores the normal promotion requirements and cost: instead it costs any 2 resources, grants the rank bonus immediately, and makes you skip your next turn.',
