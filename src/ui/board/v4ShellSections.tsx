export const V4EndVoteModal = (props: {
  ...
  return (
    <section className="game-ui-v3-vote-popup game-ui-v4-vote-popup" role="dialog" aria-label={props.title}>
      <div className="game-ui-v3-vote-popup-card game-ui-v4-vote-popup-card">
        <h3>{props.title}</h3>
...
export const V4StandingsSummary = (props: {
  ...
  <div className="game-ui-v3-gameover-summary game-ui-v4-gameover-summary">
    <h4>{props.title}</h4>
...
export const V4GameoverModal = (props: {
  ...
  if (!props.open) return null;
  return (
    <div className="game-ui-v3-gameover-modal game-ui-v4-gameover-modal" role="dialog" aria-label={props.ariaLabel}>
      <div className="game-ui-v3-gameover-card game-ui-v4-gameover-card">
        <h3>{props.title}</h3>
        <p>
