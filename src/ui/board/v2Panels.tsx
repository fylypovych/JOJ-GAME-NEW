        ...
        <div className="game-ui-v2-chip-row">
          {opponentIds.map((pid) => (
            <button
              key={`pick-target-${pid}`}
              type="button"
              className={`game-ui-v2-pick-chip game-ui-layout-pick-chip${selectedTargetId === pid ? ' is-selected' : ''}`}
              onClick={() => {
                ...
                {replacementTargetIds.map((pid) => {
                  ...
                  return (
                    <button
                      ...
                      type="button"
                      className={`game-ui-v2-pick-chip game-ui-layout-pick-chip${replacementActiveTargetId === pid ? ' is-selected' : ''}`}
        ...
        <div className="game-ui-v2-chip-row">
          {BOARD_RESOURCE_ORDER.map((key) => (
            <button
              ...
              type="button"
              className={`game-ui-v2-pick-chip game-ui-layout-pick-chip${selectedResource === key ? ' is-selected' : ''}`}
