...
export type AdminTab = 'start' | 'matches' | 'deck' | 'import' | 'state' | 'ranks' | 'contentPages' | 'database' | 'analytics' | 'github' | 'settings' | 'simulation' | 'users' | 'awards' | 'bugReports' | 'gameConfig' | 'systemAdmin';
